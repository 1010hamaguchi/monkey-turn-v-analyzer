class SettingAnalyzer {
  ...
  calculateSettingProbabilities(inputData) {
    ...
    if (totalLikelihood === 0) {
      ...
      return { probabilities, contributions, sampleSufficiency: this.checkSampleSufficiency(inputData) };
    }
  ...
  calculateBinomialLikelihood(observed, trials, probability) {
  ...
  checkSampleSufficiency(inputData) {
...
module.exports = SettingAnalyzer;